...
<head>
    <meta charset="UTF-8">
    <title>Welcome to Stay N Go</title>
    ...
    <link rel="stylesheet" type="text/css"
        href="../../../../cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.7.1/css/bootstrap-datepicker.css" />
    <!-- MAIN STYLE -->
    ...
    <div class="Layout Layout-open Layout-expand Layout-right">
        <div class="Messenger_messenger">
            <div class="Messenger_header">
                <h4 class="Messenger_prompt">How can we help you?</h4> <span class="chat_close_icon"><i
        ...
        <div class="container">
            ...
            <div class="header-top">
                <div class="header-top-left">
                    ...
                    <span><i class="ion-ios-location-outline"></i> 121 Royal, Vadodara</span>
                    <span><i class="fa fa-phone" aria-hidden="true"></i> +91 9978476101</span>
                    <span><?php include ('voice.php'); ?></span>
                </div>
                <div class="header-top-right">
                    <ul>
                        <li class="dropdown"><a href="login.php" target="_blank" title="Login"
                                class="dropdown-toggle">LOGIN</a></li>
                        <li class="dropdown"><a href="register.php" target="_blank" title="Register"
                                class="dropdown-toggle">REGISTER</a></li>
                        <li class="dropdown"><a href="check_out.php" title="Check Out" class="dropdown-toggle">CHECK
                                OUT</a>
                        </li>
                        <li class="dropdown"><a href="reservation.php" title="#" class="dropdown-toggle">RESERVATION</a>
                        </li>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="index.php#r">Rooms</a></li>
